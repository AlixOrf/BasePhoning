...
# Toutes les activités principales
act_dict = {
...
# On remplace le code par le libellé NAF
df["activite_principale"] = (
    df["activite_principale"]
    .map(naf_dict)
...
# On remplace le code par le libellé des activités principales
print("Remplacement des activités principales...")
df["section_activite_principale"] = (
    df["section_activite_principale"]
    .map(act_dict)
    .fillna(df["section_activite_principale"])  # On conserve la valeur si code inconnu
)
print("Activités principale remplacées")

# On remplace le code par le libellé l'état administratif
print("Remplacement de l'état administratif...")
df["etat_administratif"] = (
    df["etat_administratif"]
    .map(admin_dict)
    .fillna(df["etat_administratif"])  # On conserve la valeur si code inconnu
)
print("Etat administratif remplacées")

# On remplace le code par le libellé des types d'entreprises
print("Remplacement des types d'entreprises...")
df["nature_juridique"] = (
    df["nature_juridique"]
    .map(type_dict)
    .fillna(df["nature_juridique"])  # On conserve la valeur si code inconnu
)
print("Types d'entreprises remplacées")
