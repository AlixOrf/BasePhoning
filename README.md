# **BasePhoning**
La Base Phoning, n'ayant pour le moment pas de meilleur nom, est la base de données utilisée pour téléphoner à des dirigeants d'entreprise proches de la retraite afin de leur proposer nos services.
...
Nous utilisons pour l'extraction des données cette API publique : [API Recherche d’entreprises](https://recherche-entreprises.api.gouv.fr)
...
```
En juin 2026 date de la création de ces codes, les codes NAF sont les suivants :
```
...
"28.23Z": "Fabrication de machines et d'équipements de bureau (à l'exception des ordinateurs et équipements",
...
"46.11Z": "Intermédiaires du commerce en matières premières agricoles, animaux vivants, matières premières textiles et",
...
"77.40Z": "Location-bail de propriété intellectuelle et de produits similaires, à l'exception des œuvres soumises à",
...
"84.12Z": "Administration publique (tutelle) de la santé, de la formation, de la culture et des services sociaux, autre que",
